    ...
    <div className="min-h-screen flex justify-center px-4 pt-16 pb-8 bg-gradient-to-br from-base-100 via-base-200 to-accent/20">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-neutral/60">Sign in to continue your literary journey</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-base-300">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white text-neutral/60">New to Reverie Capsule?</span>
            </div>
          </div>

          {/* Register Link */}
          <Link href="/auth/register" className="btn btn-outline border-primary text-primary w-full btn-lg hover:bg-primary hover:text-white">
            Create an Account
          </Link>
        </div>
